...
final class PoolSubpage<T> {
    ...
    final int pageSize;
    /**
     * 一个Page可以分配maxNumElems个具有elemSize大小的块，这些块的占用状态使用bitmap来保存
     * bitmap中的每一个元素可以表示64个块的状态。
     * 
     */
    final long[] bitmap;
    ...
    PoolSubpage(PoolChunk<T> chunk, int memoryMapIdx, int runOffset, int pageSize, int elemSize) {
        ...
        this.pageSize = pageSize;
        /*
         * ElemSize的最小值是16个字节，64代表long类型的64个bit位
         * 理论上，bitmap的最大长度为pageSize >>>　10,bitmap真正的有效长度保存在bitmapLength中
         */
